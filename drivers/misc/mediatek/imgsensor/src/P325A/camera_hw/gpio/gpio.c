...
#define INIT_HWID_GPIO158_STATUS
#ifdef INIT_HWID_GPIO158_STATUS
static struct pinctrl_state *ppinctrl_state_camDefault;
#endif
/*
...
#ifdef INIT_HWID_GPIO158_STATUS
	ppinctrl_state_camDefault = pinctrl_lookup_state(pgpio->ppinctrl, "default");
	if (ppinctrl_state_camDefault) {
		pinctrl_select_state(pgpio->ppinctrl, ppinctrl_state_camDefault);
		pr_info("pinctrl init default\n");
	}
#endif
	for (j = IMGSENSOR_SENSOR_IDX_MIN_NUM;
	j < IMGSENSOR_SENSOR_IDX_MAX_NUM;
