...
//TN modified by bingtai.zou/860558 20230914 EKFOGO4G-2089 BEGIN
#if IS_ENABLED(CONFIG_OEM_DEVINFO)
#include <dev_info.h>
#endif
//TN modified by bingtai.zou/860558 20230914 EKFOGO4G-2089 END
#include <linux/notifier.h>

#define ALSPSHUB_DEV_NAME     "alsps_hub_pl"
//TN Begin modified by bingtai.zou/860558 20230823 EKFOGO4G-1546 begin
#define MAX_CALI_VALUE (10000)
//TN Begin modified by bingtai.zou/860558 20230823 EKFOGO4G-1546 end
...
//TN modified by bingtai.zou/860558 20231110 EKFOGO4G-7386 begin
...
//TN modified by bingtai.zou/860558 20231110 EKFOGO4G-7386 end
static int alshub_factory_get_raw_data(int *data)
{
...
//TN modified by ye.yuan/860593 20240102 EKFOGO4G-9716 begin
static int ps_send_cali(void)
{
	pr_err("[zbt]%s enter\n", __func__);
	return sensor_calibration_to_hub(ID_PROXIMITY);
}
//TN modified by ye.yuan/860593 20240102 EKFOGO4G-9716 end
