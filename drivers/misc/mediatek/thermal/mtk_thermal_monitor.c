...
int  mtkthermal_init(void)
{
	...
	if (result)
		pr_warn("Thermal: Can not register suspend notifier_v1, ret: %d\n", result);

	result = register_pm_notifier(&thermal_pm_nb_v2);
	if (result)
		pr_warn("Thermal: Can not register suspend notifier_v2, ret: %d\n", result);
...
/*chao.zhang1@tinno.com add for EKFOGO4G-8123 begin*/
...
/*chao.zhang1@tinno.com add for EKFOGO4G-8123 end*/
...
static int __init thermal_monitor_init(void)
{
		...
		wmt_tm_init();
		tsallts_init();
		/*TN Begin modified by chao.zhang1/860682 20230802 CR/EKFOGO4G-1428*/
		mtk_ts_charger_init();
		mtktsusb_init();
		/*TN end modified by chao.zhang1/860682 20230802 CR/EKFOGO4G-1428*/
		return 0;
}
