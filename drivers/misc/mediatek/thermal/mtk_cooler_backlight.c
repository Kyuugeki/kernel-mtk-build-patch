...
static void mtk_cl_backlight_set_max_brightness_limit(void)
{
	if (g_backlight_last_level != g_backlight_level) {
		...
		switch (g_backlight_level) {
			/* TN Begin modified by kexin.wang/860557 20230817 CR/EKFOGO4G-1514*/
			case 0:
				/* 100% */
			...
			case 1:
				/* 70% */
				setMaxBrightness("lcd-backlight", 1432, 0);
				break;
			case 2:
				/* 40% */
				setMaxBrightness("lcd-backlight", 818, 1);
				break;
			case 3:
				/* 10% */
				setMaxBrightness("lcd-backlight", 204, 1);
				break;
			default:
				setMaxBrightness("lcd-backlight", 2047, 0);
				break;
			/* TN end modified by kexin.wang/860557 20230817 CR/EKFOGO4G-1514*/
		}
	}
}
